...
if st.session_state.show_text:
    st.write("""
        ...
        [Solicitar Confirmar el Mail; si el mail no coincide se debe solicitar la 
        actualización de esta información, bajo el flujo definido en este proceso]. 
        ...
        transacciones que usted está desconociendo. Finalmente es necesario indicarle, 
        que se realizará una investigación interna de los desconocimientos realizados por 
        los clientes, y en la medida que se cuente con evidencias de mecanismos robustos 
        de seguridad, la empresa podrá hacer uso de las acciones legales que otorga la ley.
    """)
