...
if st.session_state.show_text:
    st.write('Don / Sra.…. de conformidad a lo dispuesto en la Ley 20.009, le informo que, para hacer efectiva su reclamación sobre aquellas operaciones respecto de las cuales desconoce haber otorgado su autorización o consentimiento, se solicita completar en su totalidad la Declaración Jurada que le enviaremos al correo electrónico que tiene registrado en nuestros sistemas y enviarla junto a su Cédula de Identidad, en un plazo de 30 días hábiles. [Solicitar Confirmar el Mail; si el mail no coincide se debe solicitar la actualización de esta información, bajo el flujo definido en este proceso]. En esa misma instancia, y de acuerdo a lo señalado por la Ley, se requiere para la cancelación de los cargos o la restitución de los fondos correspondientes a las operaciones reclamadas, que nos haga llegar también el respaldo de la denuncia por los hechos constitutivos del delito de fraude que usted debe efectuar ante al menos uno de los siguientes organismos: el Ministerio Público, funcionarios de Carabineros de Chile, de la Policía de Investigaciones, o ante cualquier tribunal con competencia criminal.Le sugerimos consultar con sus familiares o adicional si alguno realizó estas transacciones que usted está desconociendo. Finalmente es necesario indicarle, que se realizará una investigación interna de los desconocimiento realizados por los clientes, y en la medida que se cuente con evidencias de mecanismos robustos de seguridad, la empresa podrá hacer uso de las las acciones legales que otorga la ley.")
